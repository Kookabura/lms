<?php
/**
 *  Ukrainian Lexicon Entries for LMS (by viktorminator)
 */
...
$_lang['lms_section'] = 'Розділ';
$_lang['ticket'] = 'Тікет';
$_lang['ticket_all'] = 'Все';
$_lang['ticket_menu_desc'] = 'Управління коментарями і не тільки.';
$_lang['comments_all'] = 'Всі коментарі';

$_lang['lms_section_create_here'] = 'Розділ з тікетами';
$_lang['lms_section_new'] = 'Новий розділ тікетів';
...
$_lang['lms_err_unknown'] = 'Відбулася невідома помилка.';
$_lang['lms_message_close_all'] = 'закрити все';
