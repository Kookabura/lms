...
require_once MODX_CORE_PATH . 'components/lms/processors/mgr/test/create.class.php';
/** @noinspection PhpIncludeInspection */
require_once MODX_CORE_PATH . 'components/lms/processors/mgr/test/update.class.php';

class Test extends modResource {
	...
	public static function getControllerPath(xPDO &$modx) {
		return $modx->getOption('lms.core_path', null, $modx->getOption('core_path') . 'components/lms/') . 'controllers/test/';
	}
	...
	public function getContextMenuText() {
		...
		return array(
			...
			'text_create_here' => $this->xpdo->lexicon('test_create_here'),
		);
	}
	...
	public function process() {
		if ($this->privateweb && !$this->xpdo->hasPermission('ticket_view_private') && $id = $this->getOption('lms.private_ticket_page')) {
			...
			$this->xpdo->setPlaceholders($this->getVirtualFields(), 'test_');
	...
	/**
	 * Shorthand for getting virtual Test fields
	 *
