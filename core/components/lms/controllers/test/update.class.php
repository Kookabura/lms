...
class TestUpdateManagerController extends ResourceUpdateManagerController {
	/** @var  Test $resource */
	public $resource;
	...
	public function loadCustomCssJs() {
		...
		$this->addLastJavascript($LMS->config['jsUrl'] . 'mgr/test/update.js');

		$ready = array(
			'xtype' => 'lms-page-test-update',
