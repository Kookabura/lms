...
/**
 * The create manager controller for Module.
 *
 * @package lms
 */
class ModuleCreateManagerController extends ResourceCreateManagerController {
	/** @var Course $resource */
	public $parent;
	/** @var Module $resource */
	public $resource;
	...
	public function loadCustomCssJs() {
		...
		$this->addLastJavascript($LMS->config['jsUrl'] . 'mgr/module/create.js');

		$ready = array(
			'xtype' => 'lms-page-module-create',
